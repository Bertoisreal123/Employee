	...
	<div class="container" style="margin-top:50px;">
		  ...
		  <div class="card shadow p-3 mb-5 bg-body-tertiary rounded">
		   ...
		   <div class="card-body">
		    ...
		    <h4 style="font-weight:bold; letter-spacing: 1px;">ADMIN REGISTRATION FORM</h4>
		      ...
		      <div class="col-sm-7">
		       <input type="password" class="form-control" name="password"
				...
				<div class="d-flex">
			     ...
			     <a href="AdminLogin.jsp" class="card-title" style="font-size:15px; margin-left:auto;"><i class="bi bi-arrow-left-circle-fill h3"></i></a>
		     	</div>
		    </form>
