		...
		<div class="card shadow" style="padding:25px;">
			...
			<%
		        ...
		        try {
		            ...
		            // SQL query to select document information based on the id of req and employeeregister db
		            String sql = "SELECT * FROM REQ.EMPLOYEEREGISTER WHERE ID=?";
		            ...
		            if (rs.next()) {
		                ...
		                String fetchedDepartment = rs.getString("DEPARTMENT");
		                String fetchedRequestingFile = rs.getString("REQUESTINGFILE");
		    %>
			...
			<table class="table table-striped">
				<thead class="">
					<tr>
				      ...
				      <th scope="col">Requesting File</th>
				    </tr>
				</thead>
				<tbody class="table-group-divider">
		                <tr>
		                    ...
		                    <td><%= fetchedEmail %></td>
		                    <td><%= fetchedDepartment %></td>
		                    <td><%= fetchedRequestingFile %></td>
		                </tr>
				</tbody>
			</table>
